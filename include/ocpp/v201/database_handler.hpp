...
public:
    ...
    ///
    ///\param now The date to check the expiry for
    ///\retval True if succeeded
    bool authorization_cache_delete_entries_with_expiry_date_before(DateTime now);
    ...
    void authorization_cache_print_contents();
